...
class NotificationService {
  ...
  Future<void> scheduleInactivityReminder() async {
    try {
      ...
      const androidDetails = AndroidNotificationDetails(
        ...
        channelDescription: 'Gentle reminder when you have not visited in a while',
        importance: Importance.defaultImportance,
        priority: Priority.defaultPriority,
        autoCancel: true,
      );
      await _plugin.zonedSchedule(
        ...
        'Your quiet place is still here. Come back when you are ready.',
        scheduledTime,
        const NotificationDetails(android: androidDetails),
        androidScheduleMode: AndroidScheduleMode.inexactAllowWhileIdle,
      );
    ...
    try {
      ...
      final messages = <Map<String, String>>[
        ...
        },
        {
          ...
          'body': '$streakDays days in a row. That is real commitment.',
        },
        {
          'title': 'Streak: $streakDays days',
          'body': 'Consistency is self-care. You are doing amazing.',
        },
      ];
  ...
  Future<void> scheduleMoodFollowUp(double moodScore) async {
    try {
      ...
      if (moodScore <= 0.4) {
        final rng = Random();
        final lowMessages = <Map<String, String>>[
          {
            'title': 'Hey buddy, are you okay?',
            'body':
                'I heard you are feeling low. Try a breathing exercise or get some rest.',
          },
          {
            'title': 'Sending you a warm hug',
            'body':
                'It is okay to not be okay. Try journaling your thoughts - it helps.',
          },
          {
            'title': 'Be gentle with yourself',
            'body':
                'A short breathing session can calm the storm. You have got this.',
          },
          {
        ...
        final rng = Random();
        final highMessages = <Map<String, String>>[
          {
            'title': 'Great vibes!',
            'body': 'You are in a good mood - how about some feel-good music?',
          },
          {
